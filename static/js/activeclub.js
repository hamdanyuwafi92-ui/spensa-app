...
function editActiveClub(id, activeyear_id, club_id, teacher_id) {
    openModal('modalActiveClubForm', '/core/activeclub/' + id + '/update/');
    document.getElementById('modalActiveClubTitle').textContent = 'Edit Klub Aktif';
    document.getElementById('id_activeyear').value = activeyear_id;
    document.getElementById('id_club').value = club_id;
